...
// #include "/home/zxb/linux/IMX6ULL/tool/paho.mqtt.c-1.3.8/install/include/MQTTClient.h"		//包含MQTT客户端库头文件

/* ########################宏定义##################### */
#define BROKER_ADDRESS	"tcp://lbfc2398.ala.cn-hangzhou.emqxsl.cn:8883"	//然也物联平台社区版MQTT服务器地址
...
#define CLIENTID		"MQTT_FX_Client001"		//客户端id
#define USERNAME		"zzxiaobin01"			//用户名
#define PASSWORD		"18813769941"			//密码
 ...
 */
#define WILL_TOPIC		"zzxiaobin01/will"		//遗嘱主题
#define LED_TOPIC		"zzxiaobin01/led"		//LED主题
#define TEMP_TOPIC		"zzxiaobin01/temperature"	//温度主题
/* ################################################# */
